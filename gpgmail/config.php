...
$features = array(
'/images/update.png' => array('Integrated update mechanism and installer can <a href="/faq.php#3.2">auto-fix the current installation</a> after an OS update', 'update mechanism'),
...
'/images/secure.jpg' => array('Sign, encrypt, decrypt, and verify all your mails', 'mail security'),
