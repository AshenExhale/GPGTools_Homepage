...
{block name=body}
    ...
    <div id="main">
        <div id="m_content">
            ...
            <h3>How to Donate?</h3>
            <p>There are several ways to donate money to a project. Currently, we offer PayPal and Flattr donations only, but if you want to use another service please <a href="about.php">let us know</a>.</p><ul class="sub"></ul>
