...
{block name=body}
    ...
    <div id="main">
        <div id="m_content">
            ...
            to Apple OS X in the form of a single installer package.
            This allows you to sign, verify, encrypt, and decrypt files and
            e-mails. Have a look at the <a href="about.php">about section</a>
            for further details and the <a href="news.php">news section</a> to
            stay up to date.
