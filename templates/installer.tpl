    ...
    <div id="main">
        <div id="m_content">
            ...
            <p>GPGTools Installer is an open source installer for Apple OS X. It installs all related OpenPGP applications, plugins and dependencies. This is a BETA version so use at your own risk - also currently you cannot use GnuPG2 in parallel.<br/><br/></p>
                        <h3>Support</h3>
            <p>Please have a look at the <a href="http://gpgtools.lighthouseapp.com">issue section</a> and ask <a href="mailto:gpgmail-users@lists.gpgmail.org">the mailing list</a> for further support.<br/><br/></p>
            <h3>Main Features</h3>
