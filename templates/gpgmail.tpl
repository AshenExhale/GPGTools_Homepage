...
{block name=body}
    ...
    <div id="main">
        <div id="m_content">
            ...
            <h3>Support</h3>
            <p>Please have a look at the <a href="http://gpgmail.org/faq">FAQ section</a>.<br/><br/></p>
            <h3>Main Features</h3>
            ...
            <li><video id="mail-video" poster="./images/screencast.jpg" class="screenshot" controls="controls"><source src="./videos/encrypt_mail.m4v" type="video/mp4" /></video>Send an encrypted mail</li>
            </ul>
            <h3>Release Notes</h3>
