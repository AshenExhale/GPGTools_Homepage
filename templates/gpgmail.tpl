...
{block name=body}
    ...
    <div id="main">
        <div id="m_content">
            ...
            <h3>Support</h3>
            <p>Please have a look at the <a href="http://gpgmail.org/faq">FAQ section</a>. Also have a look at the <a href="http://gpgtools.lighthouseapp.com/projects/65764/home">issue section</a> and ask <a href="mailto:gpgmail-users@lists.gpgmail.org">the mailing list</a> for further support. It would be nice to <a href="http://www.apple.com/feedback/macosx.html">tell Apple</a> to support bundles for Mail.app officially.<br/><br/></p>
            <h3>Main Features</h3>
