    ...
    <div id="main">
        ...
        -->
            ...
            <ul class="sub projects">
                ...
                <li><div class="project"><a href="http://twitter.com/statuses/user_timeline/170783148.rss" title="subscribe our feed"><img src="./images/rss.png" title="subscribe our feed" alt="rss" /></a></div></li>
