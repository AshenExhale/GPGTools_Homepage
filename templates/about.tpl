...
{block name=body}
    ...
    <div id="main">
        <div id="m_content">
            ...
            <p>GPGTools is an open source initiative to bring <a href="http://en.wikipedia.org/wiki/Pretty_Good_Privacy">OpenPGP</a> to Apple OS X. This allows you to sign, verify, encrypt and decrypt files and e-mails. The project is originated from efforts revamping GPGMail developments in 2010.</p><ul class="sub"></ul>
